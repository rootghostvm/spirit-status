export const CHECK_INTERVAL_MS = Number(
  process.env.CHECK_INTERVAL_MS ?? 30_000,
);
export const CHECK_TIMEOUT_MS = Number(process.env.CHECK_TIMEOUT_MS ?? 5_000);
export const CHECK_RETRIES = Number(process.env.CHECK_RETRIES ?? 0);
